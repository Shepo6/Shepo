...
def GetMenu():
        ...
        for item in match:
            ...
            view(link)
        addDir('[COLOR red]Boxing [COLOR white]Hits Info[/COLOR]',url,10,whatsnewicon,fanarts)
        addDir('[COLOR red]Boxing [COLOR white]Search[/COLOR]',url,5,searchicon,fanarts)
...
def popup():
        ...
        if len(message)>1:
                ...
                if compfile == message:pass
                        ...
                        showText('[COLOR red]Boxing Hits[/COLOR] [COLOR white]Info[/COLOR]', message)
...
def NEW():
        ...
        if len(message)>1:
                path = xbmcaddon.Addon().getAddonInfo('path')
                showText('[COLOR red]Boxing[/COLOR] [COLOR white]Hits Info[/COLOR]', message)
                quit()
